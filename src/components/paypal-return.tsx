...
export default function PayPalReturn({
  ...
  return <section className="w-full max-w-xl rounded-[2.5rem] bg-white p-8 text-center shadow-2xl sm:p-10">
    ...
    {state === "success" && <><p className="mt-4 text-[#3b2a55]/65">Tu matrícula ya figura como pagada. Te enviaremos los datos de acceso cuando el alta esté preparada.</p><Link href="/" className="mt-7 inline-flex rounded-2xl bg-[#ffd93d] px-7 py-3 font-extrabold">Volver a Academia Mágica</Link></>}
